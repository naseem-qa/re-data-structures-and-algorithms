...
const countNumberOfElements = (arr) => {
    return arr.reduce((accumulator) => accumulator=accumulator+1);
...
let arr =str.split('')
let reverse =arr.reduce((newstr,currentLetter)=>{
...
return arr.map(el=>(el.children ? el.children.length : 0)).reduce((accumulator,value)=>
